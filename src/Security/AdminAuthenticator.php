...
/*        $user = $this->entityManager->getRepository(User::class)->findOneBy(['email' => $credentials['email']]);
        ...
        if (!$user) {
            ...
            throw new CustomUserMessageAuthenticationException("Le compte que vous recherchez n'existe pas");
        }

        if ($user->getEnabled() == false) {
            throw new CustomUserMessageAuthenticationException('Le compte pour cet utilisateur est desactivé, contactez votre administration.');
        }
